import scedule from './../../src/Excel/scedule.js'
...
const prepareSceduleForPS = (sceduleKeysArray) => {
    ...
    sceduleKeysArray.forEach(sceduleKey => {
        ...
        let filmTitlesAndAgesArr = filmTitlesArr.map(item => findFilmAge(item, films))
    ...
    console.log(JSON.stringify(preparedPSscedule))
}
