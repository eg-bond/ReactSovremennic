...
let initialState = {
  datesArr: [
    ['day0', 'Воскресенье', '26 декабря'],
    ['day1', 'Понедельник', '20 декабря'],
    ['day2', 'Вторник', '21 декабря'],
    ['day3', 'Среда', '22 декабря'],
    ['day4', 'Четверг', '23 декабря'],
    ['day5', 'Пятница', '24 декабря'],
    ['day6', 'Суббота', '25 декабря'],
  ],
