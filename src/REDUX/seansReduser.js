...
let initialState = {
  datesArr: [
    ['day0', 'Воскресенье', '19 февраля'],
    ['day1', 'Понедельник', '13 февраля'],
    ['day2', 'Вторник', '14 февраля'],
    ['day3', 'Среда', '15 февраля'],
    ['day4', 'Четверг', '16 февраля'],
    ['day5', 'Пятница', '17 февраля'],
    ['day6', 'Суббота', '18 февраля'],
  ],
