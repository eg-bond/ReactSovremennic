...
let initialState = {
    datesArr: [
        ["day0", "Воскресенье", "14 февраля"],
        ["day1", "Понедельник", "15 февраля"],
        ["day2", "Вторник", "16 февраля"],
        ["day3", "Среда", "17 февраля"],
        ["day4", "Четверг", "11 февраля"],
        ["day5", "Пятница", "12 февраля"],
        ["day6", "Суббота", "13 февраля"]
    ],
