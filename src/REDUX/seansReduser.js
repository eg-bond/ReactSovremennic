...
let initialState = {
  datesArr: [
    ['day0', 'Воскресенье', '30 января'],
    ['day1', 'Понедельник', '24 января'],
    ['day2', 'Вторник', '25 января'],
    ['day3', 'Среда', '26 января'],
    ['day4', 'Четверг', '27 января'],
    ['day5', 'Пятница', '28 января'],
    ['day6', 'Суббота', '29 января'],
  ],
