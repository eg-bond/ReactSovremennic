...
let initialState = {
  datesArr: [
    ['day0', 'Воскресенье', '15 января'],
    ['day1', 'Понедельник', '16 января'],
    ['day2', 'Вторник', '17 января'],
    ['day3', 'Среда', '18 января'],
    ['day4', 'Четверг', '12 января'],
    ['day5', 'Пятница', '13 января'],
    ['day6', 'Суббота', '14 января'],
  ],
