...
let initialState = {
  datesArr: [
    ['day0', 'Воскресенье', '20 февраля'],
    ['day1', 'Понедельник', '14 февраля'],
    ['day2', 'Вторник', '15 февраля'],
    ['day3', 'Среда', '16 февраля'],
    ['day4', 'Четверг', '17 февраля'],
    ['day5', 'Пятница', '18 февраля'],
    ['day6', 'Суббота', '19 февраля'],
  ],
