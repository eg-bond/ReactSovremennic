...
let initialState = {
  datesArr: [
    ['day0', 'Воскресенье', '18 сентября'],
    ['day1', 'Понедельник', '12 сентября'],
    ['day2', 'Вторник', '13 сентября'],
    ['day3', 'Среда', '14 сентября'],
    ['day4', 'Четверг', '15 сентября'],
    ['day5', 'Пятница', '16 сентября'],
    ['day6', 'Суббота', '17 сентября'],
  ],
