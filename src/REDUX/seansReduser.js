...
let initialState = {
  datesArr: [
    ['day0', 'Воскресенье', '17 октября'],
    ['day1', 'Понедельник', '18 октября'],
    ['day2', 'Вторник', '19 октября'],
    ['day3', 'Среда', '20 октября'],
    ['day4', 'Четверг', '14 октября'],
    ['day5', 'Пятница', '15 октября'],
    ['day6', 'Суббота', '16 октября'],
  ],
