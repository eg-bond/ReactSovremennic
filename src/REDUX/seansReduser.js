...
let initialState = {
  datesArr: [
    ['day0', 'Воскресенье', '18 декабря'],
    ['day1', 'Понедельник', '19 декабря'],
    ['day2', 'Вторник', '20 декабря'],
    ['day3', 'Среда', '21 декабря'],
    ['day4', 'Четверг', '15 декабря'],
    ['day5', 'Пятница', '16 декабря'],
    ['day6', 'Суббота', '17 декабря'],
  ],
