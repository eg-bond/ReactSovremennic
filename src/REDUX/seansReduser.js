...
let initialState = {
  datesArr: [
    ['day0', 'Воскресенье', '31 октября'],
    ['day1', 'Понедельник', '25 октября'],
    ['day2', 'Вторник', '26 октября'],
    ['day3', 'Среда', '27 октября'],
    ['day4', 'Четверг', '28 октября'],
    ['day5', 'Пятница', '29 октября'],
    ['day6', 'Суббота', '30 октября'],
  ],
