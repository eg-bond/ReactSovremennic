...
let initialState = {
  datesArr: [
    ['day0', 'Воскресенье', '23 октября'],
    ['day1', 'Понедельник', '24 октября'],
    ['day2', 'Вторник', '25 октября'],
    ['day3', 'Среда', '26 октября'],
    ['day4', 'Четверг', '20 октября'],
    ['day5', 'Пятница', '21 октября'],
    ['day6', 'Суббота', '22 октября'],
  ],
