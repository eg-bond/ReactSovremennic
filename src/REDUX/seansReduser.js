...
let initialState = {
  datesArr: [
    ['day0', 'Воскресенье', '25 декабря'],
    ['day1', 'Понедельник', '26 декабря'],
    ['day2', 'Вторник', '27 декабря'],
    ['day3', 'Среда', '28 декабря'],
    ['day4', 'Четверг', '22 декабря'],
    ['day5', 'Пятница', '23 декабря'],
    ['day6', 'Суббота', '24 декабря'],
  ],
