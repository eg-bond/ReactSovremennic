...
let initialState = {
  datesArr: [
    ['day0', 'Воскресенье', '23 апреля'],
    ['day1', 'Понедельник', '24 апреля'],
    ['day2', 'Вторник', '25 апреля'],
    ['day3', 'Среда', '26 апреля'],
    ['day4', 'Четверг', '20 апреля'],
    ['day5', 'Пятница', '21 апреля'],
    ['day6', 'Суббота', '22 апреля'],
  ],
