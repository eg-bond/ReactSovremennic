...
let initialState = {
  datesArr: [
    ['day0', 'Воскресенье', '17 апреля'],
    ['day1', 'Понедельник', '18 апреля'],
    ['day2', 'Вторник', '19 апреля'],
    ['day3', 'Среда', '20П апреля'],
    ['day4', 'Четверг', '14 апреля'],
    ['day5', 'Пятница', '15 апреля'],
    ['day6', 'Суббота', '16 апреля'],
  ],
