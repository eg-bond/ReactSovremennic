...
let initialState = {
  datesArr: [
    ['day0', 'Воскресенье', '26 сентября'],
    ['day1', 'Понедельник', '20 сентября'],
    ['day2', 'Вторник', '21 сентября'],
    ['day3', 'Среда', '22 сентября'],
    ['day4', 'Четверг', '23 сентября'],
    ['day5', 'Пятница', '24 сентября'],
    ['day6', 'Суббота', '25 сентября'],
  ],
