...
let initialState = {
  datesArr: [
    ['day0', 'Воскресенье', '4 сентября'],
    ['day1', 'Понедельник', '29 августа'],
    ['day2', 'Вторник', '30 августа'],
    ['day3', 'Среда', '31 августа'],
    ['day4', 'Четверг', '1 сентября'],
    ['day5', 'Пятница', '2 сентября'],
    ['day6', 'Суббота', '3 сентября'],
  ],
