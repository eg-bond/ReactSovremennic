...
let initialState = {
    datesArr: [
        ["day0", "Воскресенье", "18 апреля"],
        ["day1", "Понедельник", "12 апреля"],
        ["day2", "Вторник", "13 апреля"],
        ["day3", "Среда", "14 апреля"],
        ["day4", "Четверг", "15 апреля"],
        ["day5", "Пятница", "16 апреля"],
        ["day6", "Суббота", "17 апреля"]
    ],
