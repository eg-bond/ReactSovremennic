...
let initialState = {
  datesArr: [
    ['day0', 'Воскресенье', '25 сентября'],
    ['day1', 'Понедельник', '19 сентября'],
    ['day2', 'Вторник', '20 сентября'],
    ['day3', 'Среда', '21 сентября'],
    ['day4', 'Четверг', '22 сентября'],
    ['day5', 'Пятница', '23 сентября'],
    ['day6', 'Суббота', '24 сентября'],
  ],
