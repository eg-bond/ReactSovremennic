...
let initialState = {
  datesArr: [
    ['day0', 'Воскресенье', '22 января'],
    ['day1', 'Понедельник', '23 января'],
    ['day2', 'Вторник', '24 января'],
    ['day3', 'Среда', '25 января'],
    ['day4', 'Четверг', '19 января'],
    ['day5', 'Пятница', '20 января'],
    ['day6', 'Суббота', '21 января'],
  ],
