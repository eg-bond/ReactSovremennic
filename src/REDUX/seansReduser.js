...
let initialState = {
  datesArr: [
    ['day0', 'Воскресенье', '19 декабря'],
    ['day1', 'Понедельник', '13 декабря'],
    ['day2', 'Вторник', '14 декабря'],
    ['day3', 'Среда', '15 декабря'],
    ['day4', 'Четверг', '16 декабря'],
    ['day5', 'Пятница', '17 декабря'],
    ['day6', 'Суббота', '18 декабря'],
  ],
