...
let initialState = {
  datesArr: [
    ['day0', 'Воскресенье', '1 мая'],
    ['day1', 'Понедельник', '25 апреля'],
    ['day2', 'Вторник', '26 апреля'],
    ['day3', 'Среда', '27 апреля'],
    ['day4', 'Четверг', '28 апреля'],
    ['day5', 'Пятница', '29 апреля'],
    ['day6', 'Суббота', '30 апреля'],
  ],
