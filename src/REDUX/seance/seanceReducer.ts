...
const initialState: SeanceStateT = {
  datesArr: [
    ['day4', 'Четверг', '25 декабря'],
    ['day5', 'Пятница', '26 декабря'],
    ['day6', 'Суббота', '27 декабря'],
    ['day0', 'Воскресенье', '28 декабря'],
    ['day1', 'Понедельник', '29 декабря'],
    ['day2', 'Вторник', '30 декабря'],
    ['day3', 'Среда', '31 декабря'],
  ],
