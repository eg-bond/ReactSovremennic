...
const initialState: SeanceStateT = {
  datesArr: [
    ['day4', 'Четверг', '11 сентября'],
    ['day5', 'Пятница', '12 сентября'],
    ['day6', 'Суббота', '13 сентября'],
    ['day0', 'Воскресенье', '14 сентября'],
    ['day1', 'Понедельник', '15 сентября'],
    ['day2', 'Вторник', '16 сентября'],
    ['day3', 'Среда', '17 сентября'],
  ],
