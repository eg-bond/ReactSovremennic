...
const initialState: SeanceStateT = {
  datesArr: [
    ['day4', 'Четверг', '23 октября'],
    ['day5', 'Пятница', '24 октября'],
    ['day6', 'Суббота', '25 октября'],
    ['day0', 'Воскресенье', '26 октября'],
    ['day1', 'Понедельник', '27 октября'],
    ['day2', 'Вторник', '28 октября'],
    ['day3', 'Среда', '29 октября'],
  ],
