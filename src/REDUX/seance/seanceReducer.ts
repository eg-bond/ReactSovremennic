...
const initialState: SeanceStateT = {
  datesArr: [
    ['day4', 'Четверг', '3 августа'],
    ['day5', 'Пятница', '4 августа'],
    ['day6', 'Суббота', '5 августа'],
    ['day0', 'Воскресенье', '6 августа'],
    ['day1', 'Понедельник', '7 августа'],
    ['day2', 'Вторник', '8 августа'],
    ['day3', 'Среда', '9 августа'],
  ],
