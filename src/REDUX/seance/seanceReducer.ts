...
const initialState: SeanceStateT = {
  datesArr: [
    ['day4', 'Четверг', '26 сентября'],
    ['day5', 'Пятница', '27 сентября'],
    ['day6', 'Суббота', '28 сентября'],
    ['day0', 'Воскресенье', '29 сентября'],
    ['day1', 'Понедельник', '30 сентября'],
    ['day2', 'Вторник', '1 октября'],
    ['day3', 'Среда', '2 октября'],
  ],
