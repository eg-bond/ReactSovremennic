...
const initialState: SeanceStateT = {
  datesArr: [
    ['day1', 'Понедельник', '17 февраля'],
    ['day2', 'Вторник', '18 февраля'],
    ['day3', 'Среда', '19 февраля'],
    ['day4', 'Четверг', '20 февраля'],
    ['day5', 'Пятница', '21 февраля'],
    ['day6', 'Суббота', '22 февраля'],
    ['day0', 'Воскресенье', '23 февраля'],
  ],
