...
const initialState: SeanceStateT = {
  datesArr: [
    ['day4', 'Четверг', '13 ноября'],
    ['day5', 'Пятница', '14 ноября'],
    ['day6', 'Суббота', '15 ноября'],
    ['day0', 'Воскресенье', '16 ноября'],
    ['day1', 'Понедельник', '17 ноября'],
    ['day2', 'Вторник', '18 ноября'],
    ['day3', 'Среда', '19 ноября'],
  ],
