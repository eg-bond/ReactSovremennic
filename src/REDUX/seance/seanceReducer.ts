...
const initialState: SeanceStateT = {
  datesArr: [
    ['day4', 'Четверг', '18 апреля'],
    ['day5', 'Пятница', '19 апреля'],
    ['day6', 'Суббота', '20 апреля'],
    ['day0', 'Воскресенье', '21 апреля'],
    ['day1', 'Понедельник', '22 апреля'],
    ['day2', 'Вторник', '23 апреля'],
    ['day3', 'Среда', '24 апреля'],
  ],
