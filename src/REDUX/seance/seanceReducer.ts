...
const initialState: SeanceStateT = {
  datesArr: [
    ['day4', 'Четверг', '6 ноября'],
    ['day5', 'Пятница', '7 ноября'],
    ['day6', 'Суббота', '8 ноября'],
    ['day0', 'Воскресенье', '9 ноября'],
    ['day1', 'Понедельник', '10 ноября'],
    ['day2', 'Вторник', '11 ноября'],
    ['day3', 'Среда', '12 ноября'],
  ],
