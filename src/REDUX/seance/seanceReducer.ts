...
const initialState: SeanceStateT = {
  datesArr: [
    ['day1', 'Понедельник', '21 апреля'],
    ['day2', 'Вторник', '22 апреля'],
    ['day3', 'Среда', '23 апреля'],
    ['day4', 'Четверг', '24 апреля'],
    ['day5', 'Пятница', '25 апреля'],
    ['day6', 'Суббота', '26 апреля'],
    ['day0', 'Воскресенье', '27 апреля'],
  ],
