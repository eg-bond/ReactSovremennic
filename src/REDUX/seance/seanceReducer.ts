...
const initialState: SeanceStateT = {
  datesArr: [
    ['day1', 'Понедельник', '2 сентября'],
    ['day2', 'Вторник', '3 сентября'],
    ['day3', 'Среда', '4 сентября'],
    ['day4', 'Четверг', '5 сентября'],
    ['day5', 'Пятница', '6 сентября'],
    ['day6', 'Суббота', '7 сентября'],
    ['day0', 'Воскресенье', '8 сентября'],
  ],
