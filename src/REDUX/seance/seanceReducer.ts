...
const initialState: SeanceStateT = {
  datesArr: [
    ['day1', 'Понедельник', '10 февраля'],
    ['day2', 'Вторник', '11 февраля'],
    ['day3', 'Среда', '12 февраля'],
    ['day4', 'Четверг', '13 февраля'],
    ['day5', 'Пятница', '14 февраля'],
    ['day6', 'Суббота', '15 февраля'],
    ['day0', 'Воскресенье', '16 февраля'],
  ],
