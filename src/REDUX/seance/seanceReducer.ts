...
const initialState: SeanceStateT = {
  datesArr: [
    ['day4', 'Четверг', '24 октября'],
    ['day5', 'Пятница', '25 октября'],
    ['day6', 'Суббота', '26 октября'],
    ['day0', 'Воскресенье', '27 октября'],
    ['day1', 'Понедельник', '28 октября'],
    ['day2', 'Вторник', '29 октября'],
    ['day3', 'Среда', '30 октября'],
  ],
