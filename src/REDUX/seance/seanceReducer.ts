...
const initialState: SeanceStateT = {
  datesArr: [
    ['day4', 'Четверг', '21 сентября'],
    ['day5', 'Пятница', '22 сентября'],
    ['day6', 'Суббота', '23 сентября'],
    ['day0', 'Воскресенье', '24 сентября'],
    ['day1', 'Понедельник', '25 сентября'],
    ['day2', 'Вторник', '26 сентября'],
    ['day3', 'Среда', '27 сентября'],
  ],
