...
const initialState: SeanceStateT = {
  datesArr: [
    ['day1', 'Понедельник', '11 декабря'],
    ['day2', 'Вторник', '12 декабря'],
    ['day3', 'Среда', '13 декабря'],
    ['day4', 'Четверг', '14 декабря'],
    ['day5', 'Пятница', '15 декабря'],
    ['day6', 'Суббота', '16 декабря'],
    ['day0', 'Воскресенье', '17 декабря'],
  ],
