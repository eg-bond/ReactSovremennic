...
const initialState: SeanceStateT = {
  datesArr: [
    ['day4', 'Четверг', '25 сентября'],
    ['day5', 'Пятница', '26 сентября'],
    ['day6', 'Суббота', '27 сентября'],
    ['day0', 'Воскресенье', '28 сентября'],
    ['day1', 'Понедельник', '29 сентября'],
    ['day2', 'Вторник', '30 сентября'],
    ['day3', 'Среда', '1 октября'],
  ],
