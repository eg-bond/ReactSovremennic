        ...
        <div>
            <div className="container">
                <div className="row">
                    ...
                    <nav role="navigation" className="navigation navbar_custom">

                        <NavLink to="/"><img src="./Images/logo.jpg"
                                                  className="col-lg-2 col-md-2 col-sm-2 col-xs-3 logo"></img></NavLink>
