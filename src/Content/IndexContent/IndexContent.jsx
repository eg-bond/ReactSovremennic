  ...
  return (
    <div className='content__gridLeftItem--3fr'>
      ...
      <div className={'news'}>
        ...
        <p>
          • Уважаемые гости кинотеатра «Современник»! В период с 17.11.2021 по
          30.11.2021г. в суши-баре "КИН-НО", с понедельника по четверг, а также
          в воскресенье действует скидка{' '}
          <span style={{ color: 'red' }}>20%</span> на все меню (еда и напитки),
          включая доставку. Ждем вас!
        </p>
