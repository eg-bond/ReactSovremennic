...
export const sushiNew = {
  ...
  vegetable_rolls: [
    { name: '"Темпура Хенд"', ingridients: '', price: '220', picture: '' },
  ...
  mini_rolls: [
    { name: 'Филадельфия мини', ingridients: '', price: '330', picture: '' },
    { name: 'Ассорти мини', ingridients: '', price: '300', picture: '' },
    {
    ...
    { name: 'Горячий Макс мини', ingridients: '', price: '390', picture: '' },
    { name: 'Темпура мини', ingridients: '', price: '300', picture: '' },
  ],
  sets: [
    { name: 'Сет «Острые суши»', ingridients: '', price: '1500?', picture: '' },
    {
    ...
    { name: 'Сет «Макси»', ingridients: '', price: '1150', picture: '' },
    {
  ...
  brand_rolls: [
    { name: 'Фуджияма', ingridients: '', price: '690', picture: '' },
    { name: 'Филадельфия', ingridients: '', price: '570', picture: '' },
    {
    ...
    { name: 'Бостон', ingridients: '', price: '550', picture: '' },
    { name: 'Ролл с лососем', ingridients: '', price: '280', picture: '' },
    { name: 'Тоттори', ingridients: '', price: '450', picture: '' },
    { name: 'Эби', ingridients: '', price: '290', picture: '' },
    { name: 'Темпура острый', ingridients: '', price: '480', picture: '' },
    { name: 'Дракон', ingridients: '', price: '1200', picture: '' },
    { name: 'Ассорти', ingridients: '', price: '520', picture: '' },
  ],
  hot_rolls: [
    { name: 'Горячий Макс', ingridients: '', price: '750', picture: '' },
    { name: 'Хаус', ingridients: '', price: '520', picture: '' },
    { name: 'Иватэ (без риса) ', ingridients: '', price: '770', picture: '' },
    { name: 'Аканасу', ingridients: '', price: '330', picture: '' },
    {
    ...
    { name: 'Запечённый Каникама', ingridients: '', price: '220', picture: '' },
    { name: 'Запечённый Майами', ingridients: '', price: '290', picture: '' },
    { name: 'Запечённый Муругай', ingridients: '', price: '260', picture: '' },
    {
      name: 'XXL',
      ingridients:
